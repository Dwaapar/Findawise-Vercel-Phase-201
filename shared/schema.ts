...
// Import AI/ML Centralization tables (excluding conflicting exports)
export {
  aiMLModels,
  learningCycles,
  ...
  aiMLAnalytics,
  aiMLAuditTrail,
  insertAiMLModelSchema,
  insertLearningCycleSchema,
  insertPersonalizationRuleSchema,
  insertNeuronDataPipelineSchema,
  insertModelTrainingJobSchema,
  insertAiMLAnalyticsSchema,
  insertAiMLAuditTrailSchema
} from "./aiMLTables";

// Import Central Config Engine tables
export * from "./configTables";

// Import API Keys Management tables
export * from "./apiKeysTables";
...
// Import RLHF + Persona Fusion Engine tables (excluding conflicting exports)
export {
  agentRewards,
  personaProfiles,
  personaEvolution,
  rlhfTrainingSessions,
  personaSimulations,
  federationRlhfSync,
  insertAgentRewardSchema,
  insertPersonaProfileSchema,
  insertPersonaEvolutionSchema,
  insertRlhfTrainingSessionSchema,
  insertPersonaSimulationSchema,
  insertFederationRlhfSyncSchema
} from "./rlhfTables";
...
// Import Traffic Generator tables (commented out due to conflicts with moneyTrafficGrowthTables)
// export * from "./trafficGeneratorTables";

// Import Real-Time Chatbot/Assistant Module tables
export * from "./chatbotTables";

// Import AI Content Defender & Plagiarism Watchdog Module tables
export * from "./contentDefenderTables";

// Import Global Deal Sniper & Price Tracker Module tables
export * from "./dealSniperTables";

// Import Content Franchise Expansion Kit Module tables
export * from "./franchiseExpansionTables";

// Import Empire Brain "Throne Protocol" - Unified Intelligence Layer (this will have the authoritative definitions)
export * from "./empireBrainTables";
...
// BILLION-DOLLAR ENTERPRISE ADDITION: Analytics Events Archive for Data Lifecycle Management
export const analyticsEventsArchive = pgTable("analytics_events_archive", {
  id: serial("id").primaryKey(),
