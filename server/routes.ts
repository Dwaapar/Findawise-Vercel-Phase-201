...
// import { healthRouter } from "./routes/health"; // REMOVED: Conflicting with direct health endpoint
import { registerFinanceRoutes } from "./routes/finance";
import findawiseApiRoutes from "./routes/findawise-api";

// Import new API routes for traffic generators
import shortsApiRoutes from "./routes/shorts-api";
import ugcApiRoutes from "./routes/ugc-api";
import prOutreachApiRoutes from "./routes/pr-outreach-api";
import systemHealthRouter from "./api/system-health.js";
import { enterpriseAffiliateRoutes } from "./services/offer-engine/enterpriseAffiliateRoutes";
...
import empireHealingRoutes from "./routes/empire-healing";
import ultraPerformanceRoutes from "./routes/ultra-performance";
import migrationProofRoutes from "./routes/migration-proof";
import llmBrainRoutes from "./routes/llm-brain";
import localAiBrainRoutes from "./routes/localAiBrain";
import finalValidationRoutes from "./routes/final-validation";
import empireFinalizerRoutes from "./routes/empire-finalizer";
...
// Billion-Dollar Empire - 4 New Production Modules
import chatbotRoutes from "./routes/chatbotRoutes";
import contentDefenderRoutes from "./routes/contentDefenderRoutes";
import dealSniperRoutes from "./routes/dealSniperRoutes";
import franchiseExpansionRoutes from "./routes/franchiseExpansionRoutes";
...
import empireBrainRoutes from "./routes/empireBrainRoutes";
...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  // Primary health endpoint (MUST be before any auth middleware)
  ...
  // Ultra-fast minimal health endpoint for load balancers
  ...
  // ===========================================
  // Note: Moved to later in registration order with other offer routes

  // ===========================================
  // ENTERPRISE AFFILIATE NETWORK INTEGRATION (BILLION-DOLLAR GRADE)
  // Complete affiliate network management system
  // ===========================================
  app.use('/api/affiliate', enterpriseAffiliateRoutes);
  ...
  // ===========================================
  // BILLION-DOLLAR EMPIRE - 4 NEW PRODUCTION MODULES
  // Real-Time Chatbot, Content Defender, Deal Sniper, Franchise Expansion
  // ===========================================
  app.use('/api/chatbot', chatbotRoutes);
  app.use('/api/content-defender', contentDefenderRoutes);
  app.use('/api/deal-sniper', dealSniperRoutes);
  app.use('/api/franchise-expansion', franchiseExpansionRoutes);

  // ===========================================
  // EMPIRE BRAIN "THRONE PROTOCOL" - UNIFIED INTELLIGENCE LAYER
  // Billion-Dollar Empire Grade, Self-Evolving, LLM-Powered AI Orchestration
  // ===========================================
  app.use('/api/empire-brain', empireBrainRoutes);
  ...
  try {
    ...
    app.use('/api/empire-healing', empireHealingRoutes);
    app.use('/api/ultra-performance', ultraPerformanceRoutes);
    app.use('/api/migration-proof', migrationProofRoutes);
    app.use('/api/llm-brain', llmBrainRoutes);
    app.use('/api', localAiBrainRoutes);
    app.use('/api/final-validation', finalValidationRoutes);
    app.use('/api/empire-finalizer', empireFinalizerRoutes);
    console.log('✅ Empire Hardening API routes registered at /api/empire-hardening/*');
    console.log('✅ Ultra Performance API routes registered at /api/ultra-performance/*');
  } catch (error) {
  ...
  // ===========================================
  // SYSTEM HEALTH OPTIMIZATION API (EMPIRE GRADE)
  // ===========================================
  app.use('/api/system-health', systemHealthRouter);
  
  // ===========================================
  // ULTRA PERFORMANCE ENGINE API (BILLION-DOLLAR GRADE)
  // ===========================================
  app.use('/api/ultra-performance', ultraPerformanceRoutes);

  // ===========================================
  // TRAFFIC GENERATORS API (CRITICAL FOR REVENUE)
  // ===========================================
  app.use('/api/traffic/shorts', shortsApiRoutes);
  app.use('/api/traffic/ugc', ugcApiRoutes);
  app.use('/api/traffic/pr-outreach', prOutreachApiRoutes);
  
  // ===========================================
  // FINDAWISE LEGENDARY UI API
  // ===========================================
  app.use('/api', findawiseApiRoutes);
  ...
  app.get('/api/translations/providers/status', async (req, res) => {
    try {
      const providers = translationService.getProviderStatus();
  ...
  app.post('/api/translations/bulk-translate/:languageCode', async (req, res) => {
    try {
      ...
      const translationResult = await translationService.batchTranslate({
        texts,
  ...
  app.post('/api/orchestrator/run', async (req, res) => {
    try {
      ...
      res.status(500).json({ 
        success: false, 
        error: error instanceof Error ? error instanceof Error ? error.message : 'Unknown error' : 'Orchestration failed' 
      });
    }
  });
  ...
  app.post('/api/orchestrator/rollback', async (req, res) => {
    try {
      ...
      res.status(500).json({ 
        success: false, 
        error: error instanceof Error ? error instanceof Error ? error.message : 'Unknown error' : 'Rollback failed' 
      });
    }
  });
  ...
  app.post('/api/archetypes/assign', async (req, res) => {
    try {
      ...
      res.status(500).json({ 
        success: false, 
        error: error instanceof Error ? error instanceof Error ? error.message : 'Unknown error' : 'Failed to assign archetype' 
      });
    }
  });
  ...
  app.get('/api/archetypes/:id/recommendations', async (req, res) => {
    try {
      ...
      res.status(500).json({ 
        success: false, 
        error: error instanceof Error ? error instanceof Error ? error.message : 'Unknown error' : 'Failed to get archetype recommendations' 
      });
    }
  });
  ...
  app.post('/api/orchestrator/run', async (req, res) => {
    try {
      ...
      res.status(500).json({ 
        success: false, 
        error: error instanceof Error ? error instanceof Error ? error.message : 'Unknown error' : 'Failed to run orchestration' 
      });
    }
  });
  ...
  app.post('/api/orchestrator/rollback', async (req, res) => {
    try {
      ...
      res.status(500).json({ 
        success: false, 
        error: error instanceof Error ? error instanceof Error ? error.message : 'Unknown error' : 'Failed to rollback configuration' 
      });
    }
  });
  ...
  app.post('/api/orchestrator/config/lock', async (req, res) => {
    try {
      ...
      res.status(500).json({ 
        success: false, 
        error: error instanceof Error ? error instanceof Error ? error.message : 'Unknown error' : 'Failed to lock/unlock configuration' 
      });
    }
  });
  ...
  // REMOVED: Conflicting healthRouter - using direct health endpoint instead
  ...
  // Empire Validation and Hardening Routes
  const empireValidation = await import('./routes/empire-validation');
  app.use(empireValidation.default);
  ...
  app.get('/sw.js', (req, res) => {
    ...
    res.sendFile(path.join(import.meta.dirname, '../public/sw.js'));
  });
  
  app.get('/manifest.json', (req, res) => {
    res.setHeader('Content-Type', 'application/json');
    res.sendFile(path.join(import.meta.dirname, '../public/manifest.json'));
  });
  
  app.get('/offline.html', (req, res) => {
    res.sendFile(path.join(import.meta.dirname, '../public/offline.html'));
  });
  
  // Self-Evolving Offer Engine Routes
  app.use('/api/offer-engine', offerEngineRoutes);
  
  // Billion-Dollar Offer Engine Routes (moved here for proper middleware order)
  ...
  app.post('/api/layout-mutation/generate', async (req, res) => {
    try {
      ...
      res.status(500).json({
        success: false,
        error: error instanceof Error ? error.message : 'Unknown error' || 'Failed to generate personalized layout'
      });
    }
  });
  ...
  app.post('/api/layout-mutation/mutate/:instanceId', async (req, res) => {
    try {
      ...
      res.status(500).json({
        success: false,
        error: error instanceof Error ? error.message : 'Unknown error' || 'Failed to mutate layout'
      });
    }
  });
  ...
  app.post('/api/layout-mutation/personalize/:instanceId/drag-drop', async (req, res) => {
    try {
      ...
      res.status(500).json({
        success: false,
        error: error instanceof Error ? error.message : 'Unknown error' || 'Failed to apply drag-drop personalization'
      });
    }
  });
  ...
  app.get('/api/layout-mutation/templates', async (req, res) => {
    try {
      ...
      res.status(500).json({
        success: false,
        error: error instanceof Error ? error.message : 'Unknown error' || 'Failed to get layout templates'
      });
    }
  });
  ...
  app.post('/api/cultural-emotion/detect-context', async (req, res) => {
    try {
      ...
      res.status(500).json({
        success: false,
        error: error instanceof Error ? error.message : 'Unknown error' || 'Failed to detect cultural context'
      });
    }
  });
  ...
  app.post('/api/cultural-emotion/analyze-emotion', async (req, res) => {
    try {
      ...
      res.status(500).json({
        success: false,
        error: error instanceof Error ? error.message : 'Unknown error' || 'Failed to analyze emotional state'
      });
    }
  });
  ...
  app.post('/api/cultural-emotion/adapt/:userId/:sessionId', async (req, res) => {
    try {
      ...
      res.status(500).json({
        success: false,
        error: error instanceof Error ? error.message : 'Unknown error' || 'Failed to trigger adaptation'
      });
    }
  });
  ...
  app.get('/api/cultural-emotion/profiles', async (req, res) => {
    try {
      ...
      res.status(500).json({
        success: false,
        error: error instanceof Error ? error.message : 'Unknown error' || 'Failed to get cultural profiles'
      });
    }
  });
  ...
  app.get('/api/cultural-emotion/personalization-rules', async (req, res) => {
    try {
      ...
      res.status(500).json({
        success: false,
        error: error instanceof Error ? error.message : 'Unknown error' || 'Failed to get personalization rules'
      });
    }
  });
  ...
  app.get('/api/cultural-emotion/emotional-history/:userId', async (req, res) => {
    try {
      ...
      res.status(500).json({
        success: false,
        error: error instanceof Error ? error.message : 'Unknown error' || 'Failed to get emotional history'
      });
    }
  });
  ...
  app.get('/api/multi-region/system-health', async (req, res) => {
    try {
      ...
      res.status(500).json({
        success: false,
        error: error instanceof Error ? error.message : 'Unknown error' || 'Failed to get system health'
      });
    }
  });
  ...
  app.get('/api/multi-region/metrics', async (req, res) => {
    try {
      ...
      res.status(500).json({
        success: false,
        error: error instanceof Error ? error.message : 'Unknown error' || 'Failed to get region metrics'
      });
    }
  });
  ...
  app.get('/api/multi-region/disaster-recovery', async (req, res) => {
    try {
      ...
      res.status(500).json({
        success: false,
        error: error instanceof Error ? error.message : 'Unknown error' || 'Failed to get disaster recovery status'
      });
    }
  });
  ...
  app.get('/api/multi-region/predictive-insights', async (req, res) => {
    try {
      ...
      res.status(500).json({
        success: false,
        error: error instanceof Error ? error.message : 'Unknown error' || 'Failed to get predictive insights'
      });
    }
  });
  ...
  app.get('/api/multi-region/business-metrics', async (req, res) => {
    try {
      ...
      res.status(500).json({
        success: false,
        error: error instanceof Error ? error.message : 'Unknown error' || 'Failed to get business metrics'
      });
    }
  });
  ...
  app.get('/api/multi-region/performance-history', async (req, res) => {
    try {
      ...
      res.status(500).json({
        success: false,
        error: error instanceof Error ? error.message : 'Unknown error' || 'Failed to get performance history'
      });
    }
  });
  ...
  app.post('/api/multi-region/route-request', async (req, res) => {
    try {
      ...
      res.status(500).json({
        success: false,
        error: error instanceof Error ? error.message : 'Unknown error' || 'Failed to route request'
      });
    }
  });
  ...
  app.get('/api/multi-region/traffic-distribution', async (req, res) => {
    try {
      ...
      res.status(500).json({
        success: false,
        error: error instanceof Error ? error.message : 'Unknown error' || 'Failed to get traffic distribution'
      });
    }
  });
  ...
  app.get('/api/multi-region/failover-history', async (req, res) => {
    try {
      ...
      res.status(500).json({
        success: false,
        error: error instanceof Error ? error.message : 'Unknown error' || 'Failed to get failover history'
      });
    }
  });
  ...
  app.post('/api/multi-region/test-disaster-recovery/:planId', async (req, res) => {
    try {
      ...
      res.status(500).json({
        success: false,
        error: error instanceof Error ? error.message : 'Unknown error' || 'Failed to run disaster recovery test'
      });
    }
  });
  ...
  app.put('/api/multi-region/regions/:regionId', async (req, res) => {
    try {
      ...
      res.status(500).json({
        success: false,
        error: error instanceof Error ? error.message : 'Unknown error' || 'Failed to update region configuration'
      });
    }
  });
  ...
  app.post('/api/multi-region/load-balancing-rules', async (req, res) => {
    try {
      ...
      res.status(500).json({
        success: false,
        error: error instanceof Error ? error.message : 'Unknown error' || 'Failed to add load balancing rule'
      });
    }
  });

  // ===============================================
  // VITE HANDLES REACT APPLICATION SERVING
  // ===============================================
  // Note: Vite middleware (setupVite) handles React app serving automatically

  // ===========================================
  // TRAFFIC GENERATOR MODULES API (BILLION-DOLLAR EMPIRE GRADE)
  // ===========================================
  
  // Register all new traffic generator API routes
  try {
    app.use('/api/shorts', shortsApiRoutes);
    app.use('/api/ugc', ugcApiRoutes);
    app.use('/api/pr-outreach', prOutreachApiRoutes);
    console.log('✅ Traffic Generator API routes registered successfully');
  } catch (error) {
    console.log('⚠️ Traffic Generator routes initialization deferred, system remains operational');
  }
