...
export class DatabaseStorage implements IStorage {
  ...
  async updateDeviceFingerprint(id: number, fingerprint: Partial<InsertDeviceFingerprint>): Promise<DeviceFingerprint> {
    const updateData: any = { ...fingerprint };
    if (fingerprint.lastSeen) {
      updateData.lastSeen = fingerprint.lastSeen;
    }
  ...
  // Additional Session + Personalization Engine Methods - Duplicate method removed
  ...
  // Duplicate method removed - keeping only first implementation
